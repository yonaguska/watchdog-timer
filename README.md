...
2. The testing checks to insure the timeout period is at least 400 seconds, any board timing out in less than 400 seconds is rejected. It also insures the retriggering works ten times consequtively and then times out properly.
